define(['dataTables.bootstrap-requirejs'], function (datatables) {
    return {
        loadDataTables: function() {
            ...
            // Load dataTables
            // Array keeps our table names
            var tables = ['Regionaloffices', 'Mentalhealthcenters', 'Psychiatrichospitals', 'Providers'];

            _.each(tables, function(num_table) {
                $('#searchable-' + num_table).dataTable({
